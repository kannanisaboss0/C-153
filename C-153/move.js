...
//Registering components for planar and vertical movement
////Vertical Movement
...
AFRAME.registerComponent("move-submarine-planar",{
    ...
    //Calling schema and defining three states
    schema:{
    ...
    tick:function(){
        ...
        window.addEventListener("keydown",(e)=>{
            ...
            if(e.key==="w"){
                ...
                //Checking whether z position of the element is lesser than -0.02 or not
                //Case-1 -The z position is lower than -0.02
                if(this.data.posZ<-0.02){
                 this.data.posZ=-0.02 
                }

                //Case-2 -The z position is higher than -0.02
                else{
            ...
            //Case-2 -S is pressed
                ...
                //Checking whether z position of the element is greater than 0.02 or not
                //Case-1 -The z position is higher than 0.02
                if(this.data.posZ>0.02){
                    this.data.posZ=0.02 
                   }

                //Case-2 -The z position is lower than 0.02   
                else{
                    this.data.posZ+=0.000001
                   }
            }
            ...
            if(e.key==="a"){
                ...
                //Case-1 -The z position is higher than -10
                if(position.x>-10){
                    this.data.posX-=0.00001
                }
            }
            ...
            if(e.key==="d"){
                ...
                //Case-1 -The z position is lower than 10
                if(position.x<+10){
                    this.data.posX+=0.00001
                }   
            }
